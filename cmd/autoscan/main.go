...
import (
	...
	"github.com/jonathanlew1s/autoscan/migrate"
	"github.com/jonathanlew1s/autoscan/processor"
	ast "github.com/jonathanlew1s/autoscan/targets/autoscan"
	"github.com/jonathanlew1s/autoscan/targets/emby"
	"github.com/jonathanlew1s/autoscan/targets/jellyfin"
	"github.com/jonathanlew1s/autoscan/targets/plex"
	"github.com/jonathanlew1s/autoscan/triggers/a_train"
	"github.com/jonathanlew1s/autoscan/triggers/bernard"
	"github.com/jonathanlew1s/autoscan/triggers/inotify"
	"github.com/jonathanlew1s/autoscan/triggers/lidarr"
	"github.com/jonathanlew1s/autoscan/triggers/manual"
	"github.com/jonathanlew1s/autoscan/triggers/radarr"
	"github.com/jonathanlew1s/autoscan/triggers/readarr"
	"github.com/jonathanlew1s/autoscan/triggers/sonarr"
